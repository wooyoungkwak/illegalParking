		...
		<div class="card mb-2 shadow-sm rounded">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-10 h3 mb-2 ms-sm-4">
						<span class="ms-3 fw-bold" id="reportStateTypeValue"></span>
					</div>
					<div class="col-8 mb-3">
						<div class="row">
							<div class="col-2 d-flex justify-content-lg-end"><label>신고회수 : </label></div>
							<div class="col-10"><span id="overlapCount"></span></div>
							<div class="col-2 d-flex justify-content-lg-end"><label>위치 : </label></div>
							<div class="col-10"><span id="addr"></span></div>
							<div class="col-2 d-flex justify-content-lg-end"><label>신고자 :</label></div>
							<div class="col-10"><span id="name"></span></div>
							<div class="col-2 d-flex justify-content-lg-end"><label>접수시간 : </label></div>
							<div class="col-10"><span id="regDt"></span></div>
							<div class="col-2 d-flex justify-content-lg-end"><label>신고기관 : </label></div>
							<div class="col-10"><span id="governmentOfficeName"></span></div>
						</div>
					</div>
					...
					<div class="row ms-3 mb-1">
						...
						<div class="col-4">
							<span class="ms-2 fw-bold text-decoration-underline">어떻게 처리 할가요?</span>
						</div>
					</div>
